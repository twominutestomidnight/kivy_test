...
image_of_ihor = face_recognition.load_image_file('origin.jpg')
ihor_face_encoding = face_recognition.face_encodings(image_of_ihor)[0]
...
# test_image = face_recognition.load_image_file('./img/known/Bill Gates.jpg')
# test_image = face_recognition.load_image_file('sample.jpg')
